from final_control_work.Program.Functional import NewAnimal, Counter, TeachNewCommands
from final_control_work.Program.View.Output import print_animal
                                            ...
                                            match int(type_selection):
                                                case 1:
                                                    ...
                                                    choose_command = input(
                                                        'Enter the commands that the animal can perform,'
                                                        'separated by a space: ')
                                                    new_animal = NewAnimal(type_animal, choose_name, choose_birthday,
                                                                           choose_command)
