...
def create_connection():
    ...
    try:
        with connect(host="localhost", user=input("User name MySQL server: "),
...
def show_database():
    ...
    try:
        with connect(host="localhost", user=input("User name MySQL server: "),
                     password=getpass("Password: ")) as connection:
...
def create_connection_db(name_db):
    ...
    try:
        with connect(host="localhost", user=input("User name MySQL server: "),
                     password=getpass("Password: "), database=name_db) as connection:
            print(connection)
    except Error as e:
        print(e)
